...
# Categorías filtradas que nos interesan
CATEGORIAS_FILTRADAS = [22, 26, 32, 37, 38, 65811, 66523, 66630]
...
def main():
    try:
        ...
        categorias_filtradas = [c for c in categorias if c["id"] in CATEGORIAS_FILTRADAS]
        total = 0
        for marca in marcas:
